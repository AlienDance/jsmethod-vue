<template>
  <p class="lead text-center display-3 text-light mt-3 mb-5">CONTACTS</p>
  <div class="row m-0 pb-4">
    ...
    <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center">
      <div class="text-light">
        ...
        <div class="d-flex align-items-center justify-content-center lead text-center fs-4 contact-lines-socials my-2">
