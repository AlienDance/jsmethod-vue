<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary p-0 px-2">
    <div class="container-fluid">
      <!-- navbar brand / title -->
      <router-link class="navbar-brand text-light p-2 p-lg-0 d-flex align-items-center" to="/eshop">
        <span class="lead fs-2">ESHOP</span>
      </router-link>
      ...
      <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mx-lg-2 d-flex justify-content-end">
            <router-link class="nav-link lead text-light d-flex align-items-center" to="/eshop/cart">
              <svg
...
export default {
  setup() {
    const navArray = [
      { title: 'Home', to: '/eshop' },
      { title: 'Contacts', to: '/eshop/contacts' },
      { title: 'Orders', to: '/eshop/orders' }
