      ...
      <div class="col-12 d-flex justify-content-center align-items-center">
        <div class="text-dark">
          <div class="d-flex align-items-center justify-content-center lead text-center fs-4 contact-lines my-2">
            ...
            <p class="d-lg-block d-none mb-0">Our location:</p>
            <p class="ms-1 mb-0">There and here</p>
          </div>
          <div class="d-flex align-items-center justify-content-center lead text-center fs-4 contact-lines my-2">
            ...
            <p class="d-lg-block d-none mb-0">Phone:</p>
            <p class="ms-1 mb-0">+123456789</p>
          </div>
          <div class="d-flex align-items-center justify-content-center lead text-center fs-4 contact-lines my-2">
            ...
            <p class="d-lg-block d-none mb-0">Mail:</p>
            <p class="ms-1 mb-0">somemail@something.com</p>
          </div>
          <div
            class="d-flex align-items-center justify-content-center lead text-center fs-4 contact-lines-socials my-2">
